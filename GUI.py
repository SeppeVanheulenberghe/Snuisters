...
address_label = customtkinter.CTkLabel(master=tabview.tab(INFO_TAB), text="Host Name")
...
address_label = customtkinter.CTkLabel(master=tabview.tab(INFO_TAB), text="Address")
address_label.pack(padx=5, anchor=W)
...
host_phone_number_label = customtkinter.CTkLabel(
    master=tabview.tab(INFO_TAB), text="Phone Number"
)
...
host_company_name_label = customtkinter.CTkLabel(
    master=tabview.tab(INFO_TAB), text="Company Name"
)
